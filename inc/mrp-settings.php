...
<h2>Featured Images Missing?</h2>
<p>By default, the rest response from a WordPress site will only include the image ID number. Unfortunately, that doesn't help when trying to get the url.
	To make this work, you need to install and activate this plugin on the website you want to get featured images from. Of course, if you don't own or manage
	the site you want to get the images from, this won't be possible. Although, you can still get everything else besides the featured image.</p>
...
<p><a href="https://northwoodsdigital.com/contact/" target="_blank">Contact US at NorthWoodsDigital.com</a></p>
</div></div></div>
<?php }
